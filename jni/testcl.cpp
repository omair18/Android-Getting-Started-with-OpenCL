...
)
{
    ...
    std::string fileDir;
    fileDir.append("/data/data/com.example.testcl/app_execdir/");
...
extern "C" void Java_com_example_testcl_MainActivity_initOpenCL
(
    JNIEnv* env,
    jobject thisObject,
    jstring kernelName
...
extern "C" void Java_com_example_testcl_MainActivity_shutdownOpenCL
(
    JNIEnv* env,
    jobject thisObject
)
...
extern "C" void Java_com_example_testcl_MainActivity_nativeInverseOpenCL
(
    JNIEnv* env,
    jobject thisObject,
    jobject inputBitmap,
